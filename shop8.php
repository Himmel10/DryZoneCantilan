...
<main class="shop-detail-container container">
    <div class="shop-detail-header">
        <img src="./images/washerman.png" alt="Daily BubbleBox Laundry Hub" class="shop-detail-img">
    ...
    <section class="shop-services">
        ...
        <div class="services-grid">
            <div class="service-card">
                ...
                <button class="add-to-cart-btn" onclick="addToCart('Wash & Fold', 'Washerman Laundry Shop', 33)">
            ...
            <div class="service-card">
                ...
                <button class="add-to-cart-btn" onclick="addToCart('Dry Cleaning', 'Washerman Laundry Shop', 170)">
                    <i class="fas fa-shopping-cart"></i> Add to Cart
                </button>
            </div>
            <div class="service-card">
                ...
                <button class="add-to-cart-btn" onclick="addToCart('Mattress Cleaning', 'Washerman Laundry Shop', 250)">
                    <i class="fas fa-shopping-cart"></i> Add to Cart
                </button>
            </div>
            <!-- Ironing -->
            <div class="service-card">
                ...
                <button class="add-to-cart-btn" onclick="addToCart('Ironing', 'Washerman Laundry Shop', 30)">
                    <i class="fas fa-shopping-cart"></i> Add to Cart
                </button>
            </div>
        </div>
    ...
    <?php $shop_name = 'Washerman Laundry Shop'; include 'modules/reviews_inc.php'; ?>
</main>
