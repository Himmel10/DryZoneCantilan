...
<main class="shop-detail-container container">
    <div class="shop-detail-header">
        <a href="./images/fluff.png" class="photo-link">
            <img src="./images/fluff.png" alt="Fluff N' Fold Express Laundry Shop" class="shop-detail-img">
        </a>
        <div class="shop-detail-info">
            ...
            <div class="shop-message">
                <button class="message-btn" onclick="window.location.href='chat.php?shop=Fluff N\' Fold Express Laundry Shop'">
    ...
    <section class="shop-services">
        ...
        <div class="services-grid">
            ...
            <div class="service-card">
                ...
                <button class="add-to-cart-btn" onclick="addToCart('Wash & Fold', 'Fluff N\' Fold Express Laundry Shop', 35)">
            ...
            <div class="service-card">
                ...
                <button class="add-to-cart-btn" onclick="addToCart('Dry Cleaning', 'Fluff N\' Fold Express Laundry Shop', 190)">
                    <i class="fas fa-shopping-cart"></i> Add to Cart
                </button>
            </div>
            ...
            <div class="service-card">
                ...
                <button class="add-to-cart-btn" onclick="addToCart('Ironing', 'Fluff N\' Fold Express Laundry Shop', 28)">
                    <i class="fas fa-shopping-cart"></i> Add to Cart
                </button>
            </div>
            ...
            <div class="service-card">
                ...
                <button class="add-to-cart-btn" onclick="addToCart('Mattress Cleaning', 'Fluff N\' Fold Express Laundry Shop', 260)">
                    <i class="fas fa-shopping-cart"></i> Add to Cart
                </button>
            </div>
            ...
            <div class="service-card">
                ...
                <button class="add-to-cart-btn" onclick="addToCart('Starch Service', 'Fluff N\' Fold Express Laundry Shop', 25)">
                    <i class="fas fa-shopping-cart"></i> Add to Cart
                </button>
            </div>
            ...
            <div class="service-card">
                ...
                <button class="add-to-cart-btn" onclick="addToCart('Delicate Wear', 'Fluff N\' Fold Express Laundry Shop', 50)">
                    <i class="fas fa-shopping-cart"></i> Add to Cart
                </button>
            </div>
        </div>
    ...
    <section class="shop-photos">
        ...
        <div class="photos-row">
            <a href="./images/shop3.1.webp" class="photo-link"><img src="./images/shop3.1.webp" alt="Shop Interior"></a>
            <a href="./images/shop3.2.jpg" class="photo-link"><img src="./images/shop3.2.jpg" alt="Machines"></a>
        </div>
    </section>
    <div class="shop-actions">
        <a href="chat.php?shop=Fluff%20N%27%20Fold%20Express%20Laundry%20Shop"><button class="btn" id="chatBtn"><i class="fas fa-comments"></i> Chat</button></a>
        <a href="modules/cart.php"><button class="btn"><i class="fas fa-shopping-cart"></i> View Cart</button></a>
    </div>
    <?php $shop_name = "Fluff N' Fold Express Laundry Shop"; include 'modules/reviews_inc.php'; ?>
</main>
