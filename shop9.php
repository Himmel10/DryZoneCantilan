...
<main class="shop-detail-container container">
    <div class="shop-detail-header">
        <a href="./images/everybody.png" class="photo-link">
            <img src="./images/everybody.png" alt="Daily BubbleBox Laundry Hub" class="shop-detail-img">
        </a>
        <div class="shop-detail-info">
            ...
            <div class="shop-message">
                <button class="message-btn" onclick="window.location.href='chat.php?shop=Laundry Express'">
    ...
    <section class="shop-services">
        ...
        <div class="services-grid">
            <div class="service-card">
                ...
                <button class="add-to-cart-btn" onclick="addToCart('Wash & Fold', 'Everybody Laundry Shop', 50)">
            ...
            <div class="service-card">
                ...
                <button class="add-to-cart-btn" onclick="addToCart('Dry Cleaning', 'Everybody Laundry Shop', 180)">
                    <i class="fas fa-shopping-cart"></i> Add to Cart
                </button>
            </div>
            <div class="service-card">
                ...
                <button class="add-to-cart-btn" onclick="addToCart('Mattress Cleaning', 'Everybody Laundry Shop', 350)">
                    <i class="fas fa-shopping-cart"></i> Add to Cart
                </button>
            </div>
            <!-- Ironing -->
            <div class="service-card">
                ...
                <button class="add-to-cart-btn" onclick="addToCart('Ironing', 'Everybody Laundry Shop', 30)">
                    <i class="fas fa-shopping-cart"></i> Add to Cart
                </button>
            </div>
        </div>
    ...
    <?php $shop_name = 'Everybody Laundry Shop'; include 'modules/reviews_inc.php'; ?>
</main>
