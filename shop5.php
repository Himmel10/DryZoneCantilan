...
<main class="shop-detail-container container">
    <div class="shop-detail-header">
        <a href="./images/EP.jpg" class="photo-link">
            <img src="./images/EP.jpg" alt="EP Laundry Hub" class="shop-detail-img">
        </a>
        <div class="shop-detail-info">
            ...
            <div class="shop-message">
                <button class="message-btn" onclick="window.location.href='chat.php?shop=EP Laundry Hub'">
    ...
    <section class="shop-services">
        ...
        <div class="services-grid">
            <div class="service-card">
                ...
                <button class="add-to-cart-btn" onclick="addToCart('Wash & Fold', 'EP Laundry Hub', 32)">
            ...
            <div class="service-card">
                ...
                <button class="add-to-cart-btn" onclick="addToCart('Dry Cleaning', 'EP Laundry Hub', 170)">
                    <i class="fas fa-shopping-cart"></i> Add to Cart
                </button>
            </div>
            <div class="service-card">
                ...
                <button class="add-to-cart-btn" onclick="addToCart('Mattress Cleaning', 'EP Laundry Hub', 250)">
                    <i class="fas fa-shopping-cart"></i> Add to Cart
                </button>
            </div>
            <!-- Ironing -->
            <div class="service-card">
                ...
                <button class="add-to-cart-btn" onclick="addToCart('Ironing', 'EP Laundry Hub', 30)">
                    <i class="fas fa-shopping-cart"></i> Add to Cart
                </button>
            </div>
        </div>
    ...
    <section class="shop-photos">
        ...
        <div class="photos-row">
            <a href="./images/shop5.1.jpg" class="photo-link"><img src="./images/shop5.1.jpg" alt="Shop Interior"></a>
            <a href="./images/shop5.2.jpg" class="photo-link"><img src="./images/shop5.2.jpg" alt="Machines"></a>
        </div>
    </section>
    ...
    <?php $shop_name = 'EP Laundry Hub'; include 'modules/reviews_inc.php'; ?>
</main>
